...
$meta_boxes[] = array(
	...
	'fields' => array(
					...
					array(
						'name'		=> 'Exclude Portfolio Category',
...
$meta_boxes[] = array(
	...
	'fields' => array(
		...
		array(
			...
			'id'		=> $prefix . 'ns_intro_back_mp4_video',
			'clone'		=> false,
			'type'		=> 'image_advanced',
			'max_file_uploads' => '1',
...
$meta_boxes[] = array(
	...
	'fields' => array(
		...
		array(
		  ...
		  array(
				'name'       => esc_attr__( 'Number Of Post Show', 'nastik' ),
		   ...
		   array(
			...
			'desc'		=> 'Translate Option.<br> Working Only If Filter Option  Disable.',
			'clone'		=> false,
			'type'		=> 'text',
			'std'		=> ''
		   ),
...
$meta_boxes[] = array(
	...
	'fields' => array(
		...
		array(
		'name'		=> 'Video Background Image',
		'id'		=> $prefix . 'ns_port_details_page_header_back_st8',
		'clone'		=> false,
		'type'		=> 'image_advanced',
		'max_file_uploads' => '1',
		'desc'		=> 'Working as a section background for mobile version. If image not uploaded featured image will work as a section background for mobile version.',
...
$meta_boxes[] = array(
	...
	'fields' => array(
		array(
				...
				'type'		=> 'text',
				'std'		=> '',
				'desc'		=> 'Working only details stye video types.',
		),
		...
		array(
				...
				'fields' => array(
					...
					'type'		=> 'image_advanced',
					'max_file_uploads' => '1000',
					'desc'		=> 'Upload same size images for details page style Slider 2.',
					),
