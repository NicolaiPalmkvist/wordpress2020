    ...
    // ACTUAL DECLARATION OF SECTIONS
                Redux::setSection( $opt_name, array(
                    ...
                    array(
							...
							'subtitle' => esc_attr__('If you Want to use WP Bakery by default element and Addons then you need to disable ajax loading', 'nastik'),
							'desc' => '',
							'options' => array(
				...
				Redux::setSection( $opt_name, array(
					...
					array(
		                    ...
		                    'notice' => true,
		                    'style' => 'info',
							'title' => esc_attr__('Product Details Page Header Options', 'nastik'),
							'desc' => esc_attr__(' ', 'nastik')
					...
					array(
							...
							'subtitle' => esc_attr__('Product Details PageTitle', 'nastik'),
				...
				Redux::setSection( $opt_name, array(
                    ...
                    'fields' => array(  
						...
						array(
			                ...
			                'desc' => esc_html__('Entry Headings in Header/Left Sidebar/ Menu', 'nastik')
			            ),
						
						array(
                            'id'          => 'typo_header_entry',
                            'type'        => 'typography', 
                            'title'       => esc_html__('Menu, Header Button, Header Search', 'nastik'),
                            'google'      => true, 
                            'font-backup' => false,
                            'output'      => array('.menu-button-text, .folio-btn-tooltip, .search-btn span, .blog-search-wrap input'),
                            'units'       =>'px',
							'line-height'       =>false,
						...
						array(
                            ...
                            'google'      => true, 
                            'font-backup' => false,
                            'output'      => array('.half-hero-wrap h1, .hero-section .section-title h2, .hero-title .section-title h2'),
                            'units'       =>'px',
							'line-height'       =>false,
						...
						array(
                            ...
                            'google'      => true, 
                            'font-backup' => false,
                            'output'      => array('.fixed-column-wrap_title h2, .page-template-default .hero-section .section-title h2'),
                            'units'       =>'px',
							'line-height'       =>false,
						...
						array(
                            ...
                            'google'      => true, 
                            'font-backup' => false,
                            'output'      => array('.split-sceen-content_title p'),
                            'units'       =>'px',
							'line-height'       =>false,
						...
						array(
                            ...
                            'type'        => 'typography', 
                            'title'       => esc_html__('Post Content', 'nastik'),
                            'google'      => true, 
                            'font-backup' => false,
                            'output'      => array('.post p'),
                            'units'       =>'px',
							'line-height'       =>false,
                            'subtitle'    => esc_html__('Specify the post content font properties.', 'nastik'),
                            'default'     => array(
                            'color'       => false,
                            'font-style'  => false,
                            'font-family' => false,
						...
						array(
                            ...
                            'type'        => 'typography', 
                            'title'       => esc_html__('Tab Name', 'nastik'),
                            'google'      => true, 
                            'font-backup' => false,
                            'output'      => array('.tabs-menu li a'),
                            'units'       =>'px',
							'line-height'       =>false,
                            'subtitle'    => esc_html__('Specify the portfolio tab name font properties.', 'nastik'),
                            'default'     => array(
                            'color'       => false,
                            'font-style'  => false,
                            'font-family' => false,
						...
						array(
                            ...
                            'type'        => 'typography', 
                            'title'       => esc_html__('Tab Section Title', 'nastik'),
                            'google'      => true, 
                            'font-backup' => false,
                            'output'      => array('.tab-content .pr-subtitle'),
                            'units'       =>'px',
							'line-height'       =>false,
                            'subtitle'    => esc_html__('Specify the portfolio tab section title font properties.', 'nastik'),
                            'default'     => array(
                            'color'       => false,
                            'font-style'  => false,
                            'font-family' => false,
						...
						array(
                            ...
                            'google'      => true, 
                            'font-backup' => false,
                            'output'      => array('.footer-widget li, .footer-widget li a'),
                            'units'       =>'px',
							'line-height'       =>false,
