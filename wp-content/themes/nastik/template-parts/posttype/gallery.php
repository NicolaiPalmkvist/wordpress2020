                                            ...
                                            <div class="single-slider fl-wrap">
                                                <div class="swiper-container">
													...
													<?php foreach ( $nastik_images as $nastik_image ){ ?>
                                                        <div class="swiper-slide hov_zoom"><img src="<?php echo esc_url(($nastik_image['url']));?>" alt="<?php echo esc_attr(($nastik_image['url']));?>"><a href="<?php echo esc_url(($nastik_image['url']));?>" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a></div>
                                                     <?php } ;?>   
                                                    </div>
                                                </div>
